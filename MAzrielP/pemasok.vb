Public Class pemasok
    ...
    Sub kondisiAwal()
        ...
        Da = New SqlClient.SqlDataAdapter("Select * From pemasok ", Conn)
        Ds = New DataSet
        Da.Fill(Ds, "pemasok")
    ...
    Private Sub Form4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'PerbaranganDataSet2.pemasok' table. You can move, or remove it, as needed.
        Me.PemasokTableAdapter.Fill(Me.PerbaranganDataSet2.pemasok)
        Call kondisiAwal()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            Dim ganti As String = "Insert into pemasok values('" & Kode.Text & "','" & Nama.Text & "','" & Alamat.Text & "','" & Telepon.Text & "')"
    ...
    Private Sub Tukar_Click(sender As Object, e As EventArgs) Handles Tukar.Click
        Call connectionThree()
        Cmd = New SqlClient.SqlCommand("Select kode_pemasok From pemasok Where kode_pemasok ='" & TextBox1.Text & "'", Conn)
    ...
    Private Sub Button5_Click_1(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        If Alamat.Text = "" And Telepon.Text = "" Then
            rubah = "Update pemasok set nama_pemasok ='" & Nama.Text & "'where kode_pemasok ='" & TextBox1.Text & "'"
        ElseIf Nama.Text = "" And Telepon.Text = "" Then
            rubah = "Update pemasok set alamat ='" & Alamat.Text & "'where kode ='" & TextBox1.Text & "'"
        ElseIf Nama.Text = "" And Alamat.Text = "" Then
            rubah = "Update pemasok set No_telp ='" & Telepon.Text & "'where kode_pemasok ='" & TextBox1.Text & "'"
        ElseIf Nama.Text = "" Then
            rubah = "Update pemasok SET alamat ='" & Alamat.Text & "',no_telp = '" & Telepon.Text & "'where kode_pemasok ='" & TextBox1.Text & "'"
        ElseIf Alamat.Text = "" Then
            rubah = "Update pemasok SET nama_pemasok ='" & Nama.Text & "',no_telp = '" & Telepon.Text & "'where kode_pemasok ='" & TextBox1.Text & "'"
        ElseIf Telepon.Text = "" Then
            rubah = "Update pemasok SET nama_pemasok ='" & Nama.Text & "',alamat ='" & Alamat.Text & "'where kode_pemasok ='" & TextBox1.Text & "'"
        Else
            rubah = "Update pemasok SET nama_pemasok ='" & Nama.Text & "',alamat ='" & Alamat.Text & "',no_telp = '" & Telepon.Text & "'where kode_pemasok ='" & TextBox1.Text & "'"
        End If
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        ...
        If Rd.HasRows Then
            ...
            Button6.Visible = True
            Call connectionThree()
            Dim apus As String = "Delete From pemasok Where kode_pemasok ='" & TextBox1.Text & "'"
